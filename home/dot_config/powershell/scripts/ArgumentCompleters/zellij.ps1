...
Register-ArgumentCompleter -Native -CommandName 'zellij' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'zellij' {
            ...
            [CompletionResult]::new('--layout-string', '--layout-string', [CompletionResultType]::ParameterName, 'Raw KDL layout string to use directly (instead of a file path) if inside a session (or using the --session flag) will be added to the session as a new tab or tabs, otherwise will start a new session')
            ...
            [CompletionResult]::new('r', 'r', [CompletionResultType]::ParameterValue, 'Run a command in a new pane Returns: Created pane ID (format: terminal_<id>)')
            ...
            [CompletionResult]::new('p', 'p', [CompletionResultType]::ParameterValue, 'Load a plugin Returns: Created pane ID (format: plugin_<id>)')
            ...
            [CompletionResult]::new('e', 'e', [CompletionResultType]::ParameterValue, 'Edit file with default $EDITOR / $VISUAL Returns: Created pane ID (format: terminal_<id>)')
        ...
        'zellij;options' {
            ...
            [CompletionResult]::new('--explicit-theme-hue', '--explicit-theme-hue', [CompletionResultType]::ParameterName, 'Pin the session to a dark or light appearance ("dark" or "light"), resolved before the first render and kept authoritative over ambient host terminal reports (CSI 2031 / DSR 997). When unset, the session follows the host terminal')
            ...
            [CompletionResult]::new('--pane-frame-style', '--pane-frame-style', [CompletionResultType]::ParameterName, 'pane-frame-style')
            ...
            [CompletionResult]::new('--support-kitty-graphics-protocol', '--support-kitty-graphics-protocol', [CompletionResultType]::ParameterName, 'Whether to enable support for the Kitty graphics (image) protocol (must also be supported by the host terminal), defaults to true if the terminal supports it')
            ...
            [CompletionResult]::new('--stacked-pane-list', '--stacked-pane-list', [CompletionResultType]::ParameterName, 'stacked-pane-list')
            ...
            [CompletionResult]::new('--mouse-scroll-resize', '--mouse-scroll-resize', [CompletionResultType]::ParameterName, 'Whether Ctrl+ScrollWheel resizes panes default is true')
            [CompletionResult]::new('--scroll-mode-sync', '--scroll-mode-sync', [CompletionResultType]::ParameterName, 'Whether scrolling a pane implicitly enters (and leaving the scroll implicitly exits) Scroll mode default is true')
            ...
            [CompletionResult]::new('--mouse-hover-tips', '--mouse-hover-tips', [CompletionResultType]::ParameterName, 'Whether to show mouse hover help-text tips (resize help and group shortcuts) default is true')
            ...
            [CompletionResult]::new('--osc133-command-selection', '--osc133-command-selection', [CompletionResultType]::ParameterName, 'Whether triple-clicking inside shell-marked (OSC 133) command output selects the command and its output rather than the logical line default is true')
            [CompletionResult]::new('--word-separators', '--word-separators', [CompletionResultType]::ParameterName, 'Characters that terminate a word when double-clicking to select it, in addition to whitespace (which is always a separator) default is "[]{}<>()"')
            [CompletionResult]::new('--host-notification-protocol', '--host-notification-protocol', [CompletionResultType]::ParameterName, 'host-notification-protocol')
            ...
            [CompletionResult]::new('--nested-session-handling', '--nested-session-handling', [CompletionResultType]::ParameterName, 'How to handle a nested Zellij session detected inside a pane (ask, fullscreen, descend, never)')
            [CompletionResult]::new('--dangerously-enable-paste-buffer-read', '--dangerously-enable-paste-buffer-read', [CompletionResultType]::ParameterName, 'dangerously-enable-paste-buffer-read')
        ...
        'zellij;action' {
            ...
            [CompletionResult]::new('focus-pane-id', 'focus-pane-id', [CompletionResultType]::ParameterValue, 'Focus a specific pane by its ID')
            [CompletionResult]::new('focus-last-pane', 'focus-last-pane', [CompletionResultType]::ParameterValue, 'Change focus to the last focused frame')
            ...
            [CompletionResult]::new('toggle-no-ui-fullscreen', 'toggle-no-ui-fullscreen', [CompletionResultType]::ParameterValue, 'Toggle between fullscreen over the entire display (including the UI bars) and normal layout')
            ...
            [CompletionResult]::new('set-pane-frame-style', 'set-pane-frame-style', [CompletionResultType]::ParameterValue, 'set-pane-frame-style')
            ...
            [CompletionResult]::new('are-floating-panes-visible', 'are-floating-panes-visible', [CompletionResultType]::ParameterValue, 'Check if floating panes are visible in the specified tab (or active tab)')
        ...
        'zellij;ac;half-page-scroll-down' {
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;ac;toggle-no-ui-fullscreen' {
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;ac;toggle-pane-frames' {
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        'zellij;action;set-pane-frame-style' {
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        'zellij;ac;set-pane-frame-style' {
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        ...
        'zellij;ac;toggle-active-sync-tab' {
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('--tab-id', '--tab-id', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;action;new-pane' {
            ...
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'The pane to replace when opening in place, eg. terminal_1, plugin_2 or 3 (only effective with --in-place; defaults to the focused pane)')
            ...
            [CompletionResult]::new('--no-focus', '--no-focus', [CompletionResultType]::ParameterName, 'if set, will open the pane without changing the focus of any client, placing it relative to the pane the command was issued from')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        ...
        'zellij;ac;toggle-pane-embed-or-floating' {
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'Target a specific pane by ID (eg. terminal_1, plugin_2, or 3)')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;ac;are-floating-panes-visible' {
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 't')
            [CompletionResult]::new('--tab-id', '--tab-id', [CompletionResultType]::ParameterName, 'tab-id')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
        ...
        'zellij;action;new-tab' {
            ...
            [CompletionResult]::new('--layout-string', '--layout-string', [CompletionResultType]::ParameterName, 'Raw KDL layout string to use directly (instead of a layout file path)')
            ...
            [CompletionResult]::new('--block-until-exit-failure', '--block-until-exit-failure', [CompletionResultType]::ParameterName, 'Block until the command exits with failure (non-zero exit status) OR its pane has been closed')
            [CompletionResult]::new('--block-until-exit', '--block-until-exit', [CompletionResultType]::ParameterName, 'Block until the command exits (regardless of exit status) OR its pane has been closed')
            [CompletionResult]::new('--no-focus', '--no-focus', [CompletionResultType]::ParameterName, 'if set, will create the tab without changing the focus of any client')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            break
        }
        ...
        'zellij;ac;previous-swap-layout' {
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('--tab-id', '--tab-id', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;ac;start-or-reload-plugin' {
            [CompletionResult]::new('-c', '-c', [CompletionResultType]::ParameterName, 'c')
            [CompletionResult]::new('--configuration', '--configuration', [CompletionResultType]::ParameterName, 'configuration')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;ac;launch-or-focus-plugin' {
            [CompletionResult]::new('-c', '-c', [CompletionResultType]::ParameterName, 'c')
            [CompletionResult]::new('--configuration', '--configuration', [CompletionResultType]::ParameterName, 'configuration')
            [CompletionResult]::new('--tab-id', '--tab-id', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('-f', '-f', [CompletionResultType]::ParameterName, 'f')
        ...
        'zellij;action;launch-plugin' {
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 's')
            [CompletionResult]::new('--skip-plugin-cache', '--skip-plugin-cache', [CompletionResultType]::ParameterName, 'skip-plugin-cache')
            [CompletionResult]::new('--no-focus', '--no-focus', [CompletionResultType]::ParameterName, 'if set, will open the plugin pane without changing the focus of any client')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        'zellij;ac;launch-plugin' {
            [CompletionResult]::new('-c', '-c', [CompletionResultType]::ParameterName, 'c')
            [CompletionResult]::new('--configuration', '--configuration', [CompletionResultType]::ParameterName, 'configuration')
            [CompletionResult]::new('--tab-id', '--tab-id', [CompletionResultType]::ParameterName, 'Target a specific tab by ID')
            [CompletionResult]::new('-f', '-f', [CompletionResultType]::ParameterName, 'f')
        ...
        'zellij;ac;change-floating-pane-coordinates' {
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'The pane_id of the floating pane, eg.  terminal_1, plugin_2 or 3 (equivalent to terminal_3)')
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'The pane_id of the floating pane, eg.  terminal_1, plugin_2 or 3 (equivalent to terminal_3)')
            [CompletionResult]::new('-x', '-x', [CompletionResultType]::ParameterName, 'The x coordinates if the pane is floating as a bare integer (eg. 1) or percent (eg. 10%)')
            [CompletionResult]::new('--x', '--x', [CompletionResultType]::ParameterName, 'The x coordinates if the pane is floating as a bare integer (eg. 1) or percent (eg. 10%)')
        ...
        'zellij;ac;toggle-pane-borderless' {
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'The pane_id of the pane, eg. terminal_1, plugin_2 or 3 (equivalent to terminal_3)')
            [CompletionResult]::new('--pane-id', '--pane-id', [CompletionResultType]::ParameterName, 'The pane_id of the pane, eg. terminal_1, plugin_2 or 3 (equivalent to terminal_3)')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
        ...
        'zellij;action;switch-session' {
            ...
            [CompletionResult]::new('--layout-string', '--layout-string', [CompletionResultType]::ParameterName, 'Raw KDL layout string to use directly')
            [CompletionResult]::new('--layout-dir', '--layout-dir', [CompletionResultType]::ParameterName, 'Default folder to look for layouts')
        ...
        'zellij;action;help;write' {
            break
        }
        'zellij;action;help;write-chars' {
            break
        }
        'zellij;action;help;paste' {
            break
        }
        'zellij;action;help;send-keys' {
            break
        }
        'zellij;action;help;resize' {
            break
        }
        'zellij;action;help;focus-next-pane' {
            break
        }
        'zellij;action;help;focus-previous-pane' {
            break
        }
        'zellij;action;help;focus-pane-id' {
            break
        }
        'zellij;action;help;focus-last-pane' {
            break
        }
        'zellij;action;help;move-focus' {
            break
        }
        'zellij;action;help;move-focus-or-tab' {
            break
        }
        'zellij;action;help;move-pane' {
            break
        }
        'zellij;action;help;move-pane-backwards' {
            break
        }
        'zellij;action;help;clear' {
            break
        }
        'zellij;action;help;dump-screen' {
            break
        }
        'zellij;action;help;dump-layout' {
            break
        }
        'zellij;action;help;save-session' {
            break
        }
        'zellij;action;help;edit-scrollback' {
            break
        }
        'zellij;action;help;scroll-up' {
            break
        }
        'zellij;action;help;scroll-down' {
            break
        }
        'zellij;action;help;scroll-to-bottom' {
            break
        }
        'zellij;action;help;scroll-to-top' {
            break
        }
        'zellij;action;help;page-scroll-up' {
            break
        }
        'zellij;action;help;page-scroll-down' {
            break
        }
        'zellij;action;help;half-page-scroll-up' {
            break
        }
        'zellij;action;help;half-page-scroll-down' {
            break
        }
        'zellij;action;help;toggle-fullscreen' {
            break
        }
        'zellij;action;help;toggle-no-ui-fullscreen' {
            break
        }
        'zellij;action;help;toggle-pane-frames' {
            break
        }
        'zellij;action;help;set-pane-frame-style' {
            break
        }
        'zellij;action;help;toggle-active-sync-tab' {
            break
        }
        'zellij;action;help;new-pane' {
            break
        }
        'zellij;action;help;edit' {
            break
        }
        'zellij;action;help;switch-mode' {
            break
        }
        'zellij;action;help;toggle-pane-embed-or-floating' {
            break
        }
        'zellij;action;help;toggle-floating-panes' {
            break
        }
        'zellij;action;help;show-floating-panes' {
            break
        }
        'zellij;action;help;hide-floating-panes' {
            break
        }
        'zellij;action;help;are-floating-panes-visible' {
            break
        }
        'zellij;action;help;close-pane' {
            break
        }
        'zellij;action;help;rename-pane' {
            break
        }
        'zellij;action;help;undo-rename-pane' {
            break
        }
        'zellij;action;help;go-to-next-tab' {
            break
        }
        'zellij;action;help;go-to-previous-tab' {
            break
        }
        'zellij;action;help;close-tab' {
            break
        }
        'zellij;action;help;go-to-tab' {
            break
        }
        'zellij;action;help;go-to-tab-name' {
            break
        }
        'zellij;action;help;rename-tab' {
            break
        }
        'zellij;action;help;undo-rename-tab' {
            break
        }
        'zellij;action;help;go-to-tab-by-id' {
            break
        }
        'zellij;action;help;close-tab-by-id' {
            break
        }
        'zellij;action;help;rename-tab-by-id' {
            break
        }
        'zellij;action;help;new-tab' {
            break
        }
        'zellij;action;help;move-tab' {
            break
        }
        'zellij;action;help;previous-swap-layout' {
            break
        }
        'zellij;action;help;next-swap-layout' {
            break
        }
        'zellij;action;help;override-layout' {
            break
        }
        'zellij;action;help;query-tab-names' {
            break
        }
        'zellij;action;help;start-or-reload-plugin' {
            break
        }
        'zellij;action;help;launch-or-focus-plugin' {
            break
        }
        'zellij;action;help;launch-plugin' {
            break
        }
        'zellij;action;help;rename-session' {
            break
        }
        'zellij;action;help;pipe' {
            break
        }
        'zellij;action;help;list-clients' {
            break
        }
        'zellij;action;help;list-panes' {
            break
        }
        'zellij;action;help;list-tabs' {
            break
        }
        'zellij;action;help;current-tab-info' {
            break
        }
        'zellij;action;help;toggle-pane-pinned' {
            break
        }
        'zellij;action;help;stack-panes' {
            break
        }
        'zellij;action;help;change-floating-pane-coordinates' {
            break
        }
        'zellij;action;help;toggle-pane-borderless' {
            break
        }
        'zellij;action;help;set-pane-borderless' {
            break
        }
        'zellij;action;help;detach' {
            break
        }
        'zellij;action;help;set-dark-theme' {
            break
        }
        'zellij;action;help;set-light-theme' {
            break
        }
        'zellij;action;help;toggle-theme' {
            break
        }
        'zellij;action;help;switch-session' {
            break
        }
        'zellij;action;help;set-pane-color' {
            break
        }
        'zellij;action;help;help' {
            break
        }
        'zellij;ac;help' {
            [CompletionResult]::new('write', 'write', [CompletionResultType]::ParameterValue, 'Write bytes to the terminal')
        ...
        'zellij;ac;help;write' {
            break
        }
        'zellij;ac;help;write-chars' {
            break
        }
        'zellij;ac;help;paste' {
            break
        }
        'zellij;ac;help;send-keys' {
            break
        }
        'zellij;ac;help;resize' {
            break
        }
        'zellij;ac;help;focus-next-pane' {
            break
        }
        'zellij;ac;help;focus-previous-pane' {
            break
        }
        'zellij;ac;help;focus-pane-id' {
            break
        }
        'zellij;ac;help;focus-last-pane' {
            break
        }
        'zellij;ac;help;move-focus' {
            break
        }
        'zellij;ac;help;move-focus-or-tab' {
            break
        }
        'zellij;ac;help;move-pane' {
            break
        }
        'zellij;ac;help;move-pane-backwards' {
            break
        }
        'zellij;ac;help;clear' {
            break
        }
        'zellij;ac;help;dump-screen' {
            break
        }
        'zellij;ac;help;dump-layout' {
            break
        }
        'zellij;ac;help;save-session' {
            break
        }
        'zellij;ac;help;edit-scrollback' {
            break
        }
        'zellij;ac;help;scroll-up' {
            break
        }
        'zellij;ac;help;scroll-down' {
            break
        }
        'zellij;ac;help;scroll-to-bottom' {
            break
        }
        'zellij;ac;help;scroll-to-top' {
            break
        }
        'zellij;ac;help;page-scroll-up' {
            break
        }
        'zellij;ac;help;page-scroll-down' {
            break
        }
        'zellij;ac;help;half-page-scroll-up' {
            break
        }
        'zellij;ac;help;half-page-scroll-down' {
            break
        }
        'zellij;ac;help;toggle-fullscreen' {
            break
        }
        'zellij;ac;help;toggle-no-ui-fullscreen' {
            break
        }
        'zellij;ac;help;toggle-pane-frames' {
            break
        }
        'zellij;ac;help;set-pane-frame-style' {
            break
        }
        'zellij;ac;help;toggle-active-sync-tab' {
            break
        }
        'zellij;ac;help;new-pane' {
            break
        }
        'zellij;ac;help;edit' {
            break
        }
        'zellij;ac;help;switch-mode' {
            break
        }
        'zellij;ac;help;toggle-pane-embed-or-floating' {
            break
        }
        'zellij;ac;help;toggle-floating-panes' {
            break
        }
        'zellij;ac;help;show-floating-panes' {
            break
        }
        'zellij;ac;help;hide-floating-panes' {
            break
        }
        'zellij;ac;help;are-floating-panes-visible' {
            break
        }
        'zellij;ac;help;close-pane' {
            break
        }
        'zellij;ac;help;rename-pane' {
            break
        }
        'zellij;ac;help;undo-rename-pane' {
            break
        }
        'zellij;ac;help;go-to-next-tab' {
            break
        }
        'zellij;ac;help;go-to-previous-tab' {
            break
        }
        'zellij;ac;help;close-tab' {
            break
        }
        'zellij;ac;help;go-to-tab' {
            break
        }
        'zellij;ac;help;go-to-tab-name' {
            break
        }
        'zellij;ac;help;rename-tab' {
            break
        }
        'zellij;ac;help;undo-rename-tab' {
            break
        }
        'zellij;ac;help;go-to-tab-by-id' {
            break
        }
        'zellij;ac;help;close-tab-by-id' {
            break
        }
        'zellij;ac;help;rename-tab-by-id' {
            break
        }
        'zellij;ac;help;new-tab' {
            break
        }
        'zellij;ac;help;move-tab' {
            break
        }
        'zellij;ac;help;previous-swap-layout' {
            break
        }
        'zellij;ac;help;next-swap-layout' {
            break
        }
        'zellij;ac;help;override-layout' {
            break
        }
        'zellij;ac;help;query-tab-names' {
            break
        }
        'zellij;ac;help;start-or-reload-plugin' {
            break
        }
        'zellij;ac;help;launch-or-focus-plugin' {
            break
        }
        'zellij;ac;help;launch-plugin' {
            break
        }
        'zellij;ac;help;rename-session' {
            break
        }
        'zellij;ac;help;pipe' {
            break
        }
        'zellij;ac;help;list-clients' {
            break
        }
        'zellij;ac;help;list-panes' {
            break
        }
        'zellij;ac;help;list-tabs' {
            break
        }
        'zellij;ac;help;current-tab-info' {
            break
        }
        'zellij;ac;help;toggle-pane-pinned' {
            break
        }
        'zellij;ac;help;stack-panes' {
            break
        }
        'zellij;ac;help;change-floating-pane-coordinates' {
            break
        }
        'zellij;ac;help;toggle-pane-borderless' {
            break
        }
        'zellij;ac;help;set-pane-borderless' {
            break
        }
        'zellij;ac;help;detach' {
            break
        }
        'zellij;ac;help;set-dark-theme' {
            break
        }
        'zellij;ac;help;set-light-theme' {
            break
        }
        'zellij;ac;help;toggle-theme' {
            break
        }
        'zellij;ac;help;switch-session' {
            break
        }
        'zellij;ac;help;set-pane-color' {
            break
        }
        'zellij;ac;help;help' {
            break
        ...
        'zellij;attach' {
            ...
            [CompletionResult]::new('--close-on-exit', '--close-on-exit', [CompletionResultType]::ParameterName, 'Close the initial command''s pane immediately when it exits')
            [CompletionResult]::new('--start-suspended', '--start-suspended', [CompletionResultType]::ParameterName, 'Start the initial command suspended, only running it after you first press ENTER')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('options', 'options', [CompletionResultType]::ParameterValue, 'Change the behaviour of zellij')
            [CompletionResult]::new('help', 'help', [CompletionResultType]::ParameterValue, 'Print this message or the help of the given subcommand(s)')
        ...
        'zellij;attach;help;options' {
            break
        }
        'zellij;attach;help;help' {
            break
        }
        'zellij;a;help' {
            [CompletionResult]::new('options', 'options', [CompletionResultType]::ParameterValue, 'Change the behaviour of zellij')
        ...
        'zellij;plugin' {
            ...
            [CompletionResult]::new('--no-focus', '--no-focus', [CompletionResultType]::ParameterName, 'if set, will open the plugin pane without changing the focus of any client, placing it relative to the pane the command was issued from')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        ...
        'zellij;help;action;write' {
            break
        }
        'zellij;help;action;write-chars' {
            break
        }
        'zellij;help;action;paste' {
            break
        }
        'zellij;help;action;send-keys' {
            break
        }
        'zellij;help;action;resize' {
            break
        }
        'zellij;help;action;focus-next-pane' {
            break
        }
        'zellij;help;action;focus-previous-pane' {
            break
        }
        'zellij;help;action;focus-pane-id' {
            break
        }
        'zellij;help;action;focus-last-pane' {
            break
        }
        'zellij;help;action;move-focus' {
            break
        }
        'zellij;help;action;move-focus-or-tab' {
            break
        }
        'zellij;help;action;move-pane' {
            break
        }
        'zellij;help;action;move-pane-backwards' {
            break
        }
        'zellij;help;action;clear' {
            break
        }
        'zellij;help;action;dump-screen' {
            break
        }
        'zellij;help;action;dump-layout' {
            break
        }
        'zellij;help;action;save-session' {
            break
        }
        'zellij;help;action;edit-scrollback' {
            break
        }
        'zellij;help;action;scroll-up' {
            break
        }
        'zellij;help;action;scroll-down' {
            break
        }
        'zellij;help;action;scroll-to-bottom' {
            break
        }
        'zellij;help;action;scroll-to-top' {
            break
        }
        'zellij;help;action;page-scroll-up' {
            break
        }
        'zellij;help;action;page-scroll-down' {
            break
        }
        'zellij;help;action;half-page-scroll-up' {
            break
        }
        'zellij;help;action;half-page-scroll-down' {
            break
        }
        'zellij;help;action;toggle-fullscreen' {
            break
        }
        'zellij;help;action;toggle-no-ui-fullscreen' {
            break
        }
        'zellij;help;action;toggle-pane-frames' {
            break
        }
        'zellij;help;action;set-pane-frame-style' {
            break
        }
        'zellij;help;action;toggle-active-sync-tab' {
            break
        }
        'zellij;help;action;new-pane' {
            break
        }
        'zellij;help;action;edit' {
            break
        }
        'zellij;help;action;switch-mode' {
            break
        }
        'zellij;help;action;toggle-pane-embed-or-floating' {
            break
        }
        'zellij;help;action;toggle-floating-panes' {
            break
        }
        'zellij;help;action;show-floating-panes' {
            break
        }
        'zellij;help;action;hide-floating-panes' {
            break
        }
        'zellij;help;action;are-floating-panes-visible' {
            break
        }
        'zellij;help;action;close-pane' {
            break
        }
        'zellij;help;action;rename-pane' {
            break
        }
        'zellij;help;action;undo-rename-pane' {
            break
        }
        'zellij;help;action;go-to-next-tab' {
            break
        }
        'zellij;help;action;go-to-previous-tab' {
            break
        }
        'zellij;help;action;close-tab' {
            break
        }
        'zellij;help;action;go-to-tab' {
            break
        }
        'zellij;help;action;go-to-tab-name' {
            break
        }
        'zellij;help;action;rename-tab' {
            break
        }
        'zellij;help;action;undo-rename-tab' {
            break
        }
        'zellij;help;action;go-to-tab-by-id' {
            break
        }
        'zellij;help;action;close-tab-by-id' {
            break
        }
        'zellij;help;action;rename-tab-by-id' {
            break
        }
        'zellij;help;action;new-tab' {
            break
        }
        'zellij;help;action;move-tab' {
            break
        }
        'zellij;help;action;previous-swap-layout' {
            break
        }
        'zellij;help;action;next-swap-layout' {
            break
        }
        'zellij;help;action;override-layout' {
            break
        }
        'zellij;help;action;query-tab-names' {
            break
        }
        'zellij;help;action;start-or-reload-plugin' {
            break
        }
        'zellij;help;action;launch-or-focus-plugin' {
            break
        }
        'zellij;help;action;launch-plugin' {
            break
        }
        'zellij;help;action;rename-session' {
            break
        }
        'zellij;help;action;pipe' {
            break
        }
        'zellij;help;action;list-clients' {
            break
        }
        'zellij;help;action;list-panes' {
            break
        }
        'zellij;help;action;list-tabs' {
            break
        }
        'zellij;help;action;current-tab-info' {
            break
        }
        'zellij;help;action;toggle-pane-pinned' {
            break
        }
        'zellij;help;action;stack-panes' {
            break
        }
        'zellij;help;action;change-floating-pane-coordinates' {
            break
        }
        'zellij;help;action;toggle-pane-borderless' {
            break
        }
        'zellij;help;action;set-pane-borderless' {
            break
        }
        'zellij;help;action;detach' {
            break
        }
        'zellij;help;action;set-dark-theme' {
            break
        }
        'zellij;help;action;set-light-theme' {
            break
        }
        'zellij;help;action;toggle-theme' {
            break
        }
        'zellij;help;action;switch-session' {
            break
        }
        'zellij;help;action;set-pane-color' {
            break
        }
        'zellij;help;list-sessions' {
            break
        }
        'zellij;help;list-aliases' {
            break
        }
        'zellij;help;attach' {
            [CompletionResult]::new('options', 'options', [CompletionResultType]::ParameterValue, 'Change the behaviour of zellij')
        ...
        'zellij;help;attach;options' {
            break
        }
        'zellij;help;watch' {
            break
        }
        'zellij;help;kill-session' {
            break
        }
        'zellij;help;delete-session' {
            break
        }
        'zellij;help;kill-all-sessions' {
            break
        }
        'zellij;help;delete-all-sessions' {
            break
        }
        'zellij;help;run' {
            break
